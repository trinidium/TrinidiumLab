      ...
      >
        ...
        >
          ...
          <ul className="list-disc pl-5 space-y-3 text-slate-300">
            <li>
              Data We Collect: Information you provide (e.g., names, emails, CSV uploads), usage data, and technical
              logs to improve the Tool.
            </li>
            <li>
              How We Use Data: To operate and improve TrinidiumLab, provide features (like sending emails), and ensure
